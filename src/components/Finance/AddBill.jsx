...
const AddBill = () => {
    ...
    const handleChange = (e) => {
        ...
        if (name === "accountant_id") {
            const selectedAccountant = accountants.find(acc => acc.accountant_id === parseInt(value));
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(`${BASE_URL}/api/bills/create`, payload);
        ...
        <div className="min-h-screen bg-gradient-to-br from-[#f1f6f5] to-[#a8c3bc] p-8">
            ...
            >
                ...
                <div className="flex justify-center items-center mb-8">
                    <h2 className="text-3xl font-bold text-gray-800">Add Bill</h2>
                </div>
                        ...
                        >
                            ...
                            {accountants.map((acc) => (
                                <option key={acc.accountant_id} value={acc.accountant_id}>
                                    {acc.employee.first_name} {acc.employee.last_name} - {acc.domain} (Acc ID: {acc.accountant_id})
                                </option>
                            ))}
                        </select>
                    </div>
