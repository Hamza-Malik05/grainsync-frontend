...
export default function Orders() {
    ...
    const [orderProducts, setOrderProducts] = useState([{ product_id: '', quantity: '' }]);
    ...
    useEffect(() => {
        ...
        // Fetch sales representatives with error handling
        axios.get(`${BASE_URL}/employees/sales`)
            .then(res => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (orderProducts.some(op => !op.product_id || !op.quantity || parseFloat(op.quantity) <= 0)) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-[#aec3c1] to-[#546464] p-8">
            ...
            ><div className="flex justify-start mb-0">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 mt-2">Fill in the details below to create a new order</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Sales Rep */}
                    <div className="bg-gray-50 p-6 rounded-lg">
                        <h3 className="text-xl font-semibold text-gray-800 mb-4">Sales Representative</h3>
                    ...
                    {/* Order Products */}
                    <div className="bg-gray-50 p-6 rounded-lg">
                        <h3 className="text-xl font-semibold text-gray-800 mb-4">Order Products</h3>
                        <div className="space-y-4">
