        ...
        export default function AddEmployee() {
          ...
          const handleChange = (e) => {
            ...
            if (name === "dept_id") {
              ...
              setFormData({
                ...formData,
                department: { dept_id: parseInt(value) || "" }, // Convert to number or empty
          ...
          const handleSubmit = async (e) => {
            ...
            try {
              ...
              // NOTE: send dept_id as a top-level field to match backend Employee model
              const employeeData = {
                ...
                gender: formData.gender.toLowerCase(), // send as full lowercase
                dept_id: parseInt(formData.department.dept_id) || null,
                absences: 0,
                leaves: 21
              };
