  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const employeeResponse = await axios.get(`${BASE_URL}/api/employees/${employee_id}`);
        ...
        const attendanceResponse = await axios.get(`${BASE_URL}/api/attendance/${employee_id}/history`);
