...
const RawMaterialManager = () => {
    ...
    const handleRestock = async (unit) => {
        ...
        try {
            // 1. Update storage unit
            await axios.put(`${BASE_URL}/api/storage-units/${unit.id}`, {
                ...unit,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {storageUnits.map((unit) => {
                        ...
                        return (
                            ...
                            >
                                <h3 className="text-xl font-semibold mb-2 text-gray-800">Unit #{unit.id}</h3>
                                ...
                                <div className="mb-3">
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => handleSupplierChange(unit.id, e.target.value)}
                                    >
                                ...
                                <div className="flex items-center gap-3">
                                    <input
                                        ...
                                        onChange={(e) => handleRestockChange(unit.id, e.target.value)}
                                    />
                                    <motion.button
