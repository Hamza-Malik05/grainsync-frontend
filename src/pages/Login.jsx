...
export default function LoginPage() {
  ...
  // Prevent navigating back to this page after login
  useEffect(() => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        switch (userRole) {
          ...
          case "warehouse_manager":       navigate("/warehouse-dashboard"); break;
          case "production_supervisor":   navigate("/production-dashboard"); break;
          case "finance_manager":         navigate("/finance-dashboard"); break;
          case "sales_manager":           navigate("/sales-dashboard"); break;
          case "maintenance_engineer":    navigate("/maintenance-dashboard"); break;
          case "quality_control_officer": navigate("/quality-dashboard"); break;
